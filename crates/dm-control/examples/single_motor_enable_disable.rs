...
//!
//! ```bash
//! cargo run -p dm-control --example single_motor_enable_disable -- \
...
use dm_control::{CanBus, MotorCodec, MotorSpec, RobotBuilder, SocketCanBus};
...
\n\
Usage:\n\
  cargo run -p dm-control --example single_motor_enable_disable -- [options]\n\
\n\
Options:\n\
