...
//!
//! ```bash
//! cargo run -p dm-control --example single_motor_mit_hold -- \
...
use dm_control::{CanBus, MitCmd, MotorCodec, MotorSpec, RobotBuilder, SocketCanBus};
...
\n\
Usage:\n\
  cargo run -p dm-control --example single_motor_mit_hold -- [options]\n\
\n\
Options:\n\
