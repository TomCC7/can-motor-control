...
//!
//! ```bash
//! cargo run -p dm-control --example gripper_control -- \
...
use dm_control::{CanBus, MitCmd, MotorCodec, MotorSpec, PosVelCmd, RobotBuilder, SocketCanBus};
...
\n\
Usage:\n\
  cargo run -p dm-control --example gripper_control -- [options]\n\
\n\
Options:\n\
