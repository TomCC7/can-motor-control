//! Mapping from `dm_control::Error` (and friends) to Python exception types.

use dm_control::{CodecError, Error, TransportError};
use pyo3::PyErr;

/// Convert a `dm_control::Error` into the appropriate Python exception.
