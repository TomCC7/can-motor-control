# Gripper Opening Control Specification

## Purpose

Provide normalized gripper opening control where `0.0` means fully closed and `1.0` means fully open, backed by per-session calibration from raw motor positions to opening endpoints.
