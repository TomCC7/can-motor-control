# motor-state-refresh Specification

## Purpose

Specify motion-free motor state refresh queries across codecs, Rust group/robot APIs, Python bindings, examples, and documentation.
